...
namespace Utilities
{
    ...
    public class AutoStepRigidbody2D : AutoStepTween
    {
        ...
        protected override Tween ConstructTween(AutoSequence autoSequence, Sequence sequence)
        {
            ...
            Transform parent = autoSequence.CacheTransform.parent;
                ...
                case Type.Position:
                    {
                        ...
                        if (_duration > 0f)
                        {
                            Vector3 pos = autoSequence.CacheTransform.localPosition;
                ...
                case Type.Rotation:
                    {
                        ...
                        if (_duration > 0f)
                        {
                            Vector3 rot = autoSequence.CacheTransform.localEulerAngles;
    ...
    /// </summary>
    [System.Serializable]
    public class AutoStepDestruct : AutoStep
    {
