...
namespace Utilities
{
    public static class StatisticTrackingSystem
    {
        ...
        {
            statisticTrackers[requireTypes].Item1.OnChanged += onProgress;
        }
        ...
        {
            statisticTrackers[requireTypes].Item1.Value = progress;
        }
        public static void Progress(this StatisticType requireTypes, int progress)
        {
            statisticTrackers[requireTypes].Item1.Value = statisticTrackers[requireTypes].Item1.Value + progress;
        }
    }
}
