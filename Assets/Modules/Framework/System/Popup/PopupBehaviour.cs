...
namespace Framework
{
    ...
    public class PopupBehaviour : CacheMonoBehaviour
    {
        ...
        [Header("Config")]
        [SerializeField] protected float _openDuration = 0.4f; public float OpenDuration { get { return _openDuration; } }
        [SerializeField] protected float _closeDuration = 0.2f; public float CloseDuration { get { return _closeDuration; } }
