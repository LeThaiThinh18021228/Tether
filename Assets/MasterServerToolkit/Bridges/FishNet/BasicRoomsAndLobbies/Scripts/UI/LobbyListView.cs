...
{
    public class LobbiesListView : UIView
    {
        ...
        [SerializeField]
        private ButtonText uiButtonPrefab;
        [SerializeField]
        ...
        private void DrawGamesList(IEnumerable<GameInfoPacket> games)
        {
            if (listContainer)
            {
                ...
                foreach (GameInfoPacket gameInfo in games)
                {
                    ...
                    gamePlayersBtn.Text.SetText($"{gameInfo.OnlinePlayers} / {maxPleyers} [Show]");
                    gamePlayersBtn.name = $"gamePlayersLable_{index}";
                    gamePlayersBtn.Button.onClick.AddListener(() =>
                    {
                    ...
                    gameConnectBtn.Text.SetText("Join");
                    gameConnectBtn.Button.onClick.AddListener(() =>
                    {
